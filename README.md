...
`tools/list` at `https://gateway.pipeworx.io/wikifeed/mcp` returns the tools in the table
...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/on_this_day \
  -H 'Content-Type: application/json' \
  -d '{"month":"07","day":"20"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/on_this_day`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
